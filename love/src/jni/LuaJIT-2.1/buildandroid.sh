...
if [ -f android/armeabi/libluajit.a ] &&
		...
		[ -f android/arm64-v8a/libluajit.a ]; then
...
NDKVER[$arm64v8a]="$NDK/toolchains/aarch64-linux-android-4.9"
NDKP[$arm64v8a]="${NDKVER[$arm64v8a]}/prebuilt/windows-x86_64/bin/aarch64-linux-android-"
NDKF[$arm64v8a]="--sysroot \"$NDK/platforms/android-21/arch-arm64\""
CFLAGS[$arm64v8a]=""
...
# Android/ARM, arm64-v8a, Android 5.0+ (Lollipop)
buildLuaJIT $arm64v8a arm64-v7a
